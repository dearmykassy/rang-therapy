    ...
    <main>
      ...
      <section className="content-section" aria-labelledby="course-price-title">
        <div className="section-heading">
          <div><span className="section-label">PRICE TABLE</span><h2 id="course-price-title">코스별 시간과 금액</h2></div>
      ...
      <section className="content-section compact-note" aria-label="결제 안내">
        ...
        <div className="inline-actions"><Link href="/areas/">지역 안내 보기</Link><a href={PHONE_HREF}>전화상담</a></div>
      </section>
    </main>
  );
}
